    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Helpdesk war room</p>
          <h1>Outsourced Helpdesk Services: a support war room for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced helpdesk services guide for companies needing tier 1 helpdesk, ticket triage, and user support. The page now uses a distinct futuristic technology layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>dark panels and alert lights</figcaption></figure>
      </div>
    </section>
