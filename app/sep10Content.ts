const published = '2026-09-10' as const;
const heroImage = '/helpdesk-team.jpg' as const;

const blogSeeds = [
  {
    slug: 'help-desk-article-source-expiry-check',
  ...
  {
    slug: 'help-desk-article-screenshot-freshness',
  ...
  {
    slug: 'help-desk-article-single-owner-review',
  ...
  {
    slug: 'help-desk-article-ticket-example-redaction',
  ...
  {
    slug: 'help-desk-article-no-result-search-log',
  ...
  {
    slug: 'help-desk-article-duplicate-intent-check',
  ...
  {
    slug: 'help-desk-article-stop-condition-writing',
  ...
  {
    slug: 'help-desk-article-link-destination-review',
  ...
  {
    slug: 'help-desk-article-reader-test',
  ...
  {
    slug: 'help-desk-article-change-note',
  ...
  {
    slug: 'help-desk-article-retirement-check',
  ...
  {
    slug: 'help-desk-daily-editorial-queue-limit',
...
export const sep10BlogArticles = blogSeeds.map((article) => ({ ...article, published, minutes: 8, heroImage }));
...
const researchSeeds = [
  {
    slug: 'helpdesk-article-source-expiry-protocol',
  ...
  {
    slug: 'helpdesk-no-result-search-intent-protocol',
  ...
  {
    slug: 'helpdesk-article-reader-comprehension-protocol',
  ...
  {
    slug: 'helpdesk-article-dependency-retirement-protocol',
  ...
  {
    slug: 'helpdesk-daily-editorial-capacity-protocol',
...
export const sep10ResearchArticles = researchSeeds.map((study) => ({
  slug: study.slug,
  title: study.title,
  ...
  body: [
    ...
    `Methodology and scope: ${study.method} This is a proposed operational study for OutsourcedHelpdeskServices.com. It reports no observed customer, ticket, or employee result.`,
    ...
    `Inference boundaries and limitations: ${study.limitation} Any result would apply only to the declared sample, period, definitions, systems, and available records. It could not establish causality, a universal benchmark, customer satisfaction, legal compliance, or performance outside the sample.`,
    'Publication note: Published September 10, 2026. A result report must disclose sample size, exclusions, missing data, denominators, reviewer agreement, protocol changes, and the access date for every reference.'
  ]
}));
