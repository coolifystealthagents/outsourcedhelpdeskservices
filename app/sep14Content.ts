const published = '2026-09-14' as const;
const heroImage = '/helpdesk-team.jpg' as const;

const blogSeeds = [
  {
    slug: 'help-desk-article-source-expiry-check-september-14',
  ...
  {
    slug: 'help-desk-article-screenshot-freshness-september-14',
  ...
  {
    slug: 'help-desk-article-single-owner-review-september-14',
  ...
  {
    slug: 'help-desk-article-ticket-example-redaction-september-14',
  ...
  {
    slug: 'help-desk-article-no-result-search-log-september-14',
  ...
  {
    slug: 'help-desk-article-duplicate-intent-check-september-14',
  ...
  {
    slug: 'help-desk-article-stop-condition-writing-september-14',
  ...
  {
    slug: 'help-desk-article-link-destination-review-september-14',
  ...
  {
    slug: 'help-desk-article-reader-test-september-14',
  ...
  {
    slug: 'help-desk-article-change-note-september-14',
  ...
  {
    slug: 'help-desk-article-retirement-check-september-14',
  ...
  {
    slug: 'help-desk-daily-editorial-queue-limit-september-14',
...
export const sep14BlogArticles = blogSeeds.map((article) => ({ ...article, title: article.title + ' — September 14 review', body: ['September 14 focus: ' + article.excerpt, ...article.body], published, minutes: 8, heroImage }));
...
const researchSeeds = [
  {
    slug: 'helpdesk-article-source-expiry-protocol-september-14',
  ...
  {
    slug: 'helpdesk-no-result-search-intent-protocol-september-14',
  ...
  {
    slug: 'helpdesk-article-reader-comprehension-protocol-september-14',
  ...
  {
    slug: 'helpdesk-article-dependency-retirement-protocol-september-14',
  ...
  {
    slug: 'helpdesk-daily-editorial-capacity-protocol-september-14',
...
export const sep14ResearchArticles = researchSeeds.map((study) => ({
  slug: study.slug,
  title: study.title + ' — September 14 protocol',
  ...
  body: [
    ...
    'Publication note: Published September 14, 2026. A result report must disclose sample size, exclusions, missing data, denominators, reviewer agreement, protocol changes, and the access date for every reference.'
  ]
}));
