...
if (!route.includes('alternates:{canonical:') || !route.includes('datePublished:publicDate') || !route.includes('<time dateTime={publicDate}>')) fail('research route hooks missing');
